...
class MeshSpin {
    constructor(userDefinedProperties = {}) {
        this.props = Object.assign({ animate: true, background: false, debug: false, edgeSeperator: ',', fake3D: false, fillColor: null, fps: 60, orientation: {
                x: 0,
                y: 0,
                z: 0,
            }, scaleFactor: 50, staticRotation: {
                x: 0.01,
                y: 0.01,
                z: 0.01,
